...
from education_app.serializers.chat import (
...
class ChatViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        return Chat.objects.filter(participants__user=user).prefetch_related(
    ...
    def add_participant(self, request: Request, pk: int) -> Response:
        ...
        participant = ChatParticipant.objects.select_related("user").get(
            id=participant.id
        )
